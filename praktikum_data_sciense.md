...
Статья не является рекламой онлайн школ и курсов. 
...
Отвечаю: топовые онлайн площадки предлагают примерно одинаковый набор специальностей. Сравните три проекта: ![geekbrains](https://geekbrains.ru/courses), ![skillfactory](https://skillfactory.ru/courses/) и ![Нетологию](https://netology.ru/development). Сгруппируем результаты и узнаем, что разработка, дизайн, аналитика и тестирование ждут нас на каждой площадке. Курсы отличаются ценой, длительностью и, вероятно, построением учебного процесса.  
В пользу выбора крупной площадки говорит так же средняя длительность обучения в 8-12 месяцев. Я буду изучать новую профессию практически год. Думаю, этого времени хватит, чтобы получить уровень знаний начального специалиста. На некоторых площадках встречались курсы длительностью по 2 года. Но жажда получения новой специальности взяла свое. Обучение дольше 12 месяцев я вычеркнул из списка поступления. 

После двухнедельных поисков, чтения отзывов и сравнения цен в моем списке остались ![Яндекс.Практикум](https://praktikum.yandex.ru) и skillfactory. Цена и длительность обучения были практически равны. Практикум предлагал бесплатный вводный курс по любой из специальностей. 20 вводных заданий, создание нескольких строк кода, короткий самостоятельный проект в Jupiter Notebook. Ты мог пройти сразу все вводные и представить, что тебя ждет на курсе и в дальнейшей работе. Для меня, как для новичка в IT, это была отличная возможность познакомиться с будущими специальностями.  
Субъективное мнение, но я был в восторге от этой возможности. Финальной точкой стала развернутая программа обучения Практикума, в сравнении с конкурентом. Информация подробно отображала изучаемые темы и проекты, которые будут выполнены в процессе обучения. 
Решено, поступаю в Практикум.

Школу выбрал, время определить специальность. Проведу серьезный анализ, ведь следующие годы жизни будут связаны с результатом этого выбора.

В ноябре и декабре 2019 года Практикум предлагал 4 направления:  
...
Что делает современный человек, когда решает задачу в незнакомой области? Вероятнее всего, ищет информацию в интернете.

Первый вопрос, который я поставил перед собой – что представляют из себя данные специальности, в чем основная задача специалистов. Ответы я нашел на ![Хабре](https://habr.com/ru/company/netologyru/blog/346806/), ![Medium](https://towardsdatascience.com/exploratory-data-analysis-8fc1cb20fd15) и в интервью с представителями IT на ![Youtube](https://www.youtube.com/watch?v=fqcSTBWD9JI).  Было установлено, что Аналитик и Дата Сайентист (англ Data Scientist, дословно ученый, работающий с данными, специалист по Data Science) углубляются в анализ, работу с большим объемом данных и занимаются, грубо скажем, «прогнозированием». В то время, как веб-разработчики пишут код, который используют конечные потребители в виде сайтов или приложений. Внутри себя я склонялся больше к анализу и построению моделей, чем серьезному написанию кода. Математику и статистику мне, в целом, близки. Начинаю склонятся к аналитической работе.

IT отрасль быстро развивается. Чат-боты, голосовые помощники, системы распознования лиц и речи, виртуальные собеседования были единичным продуктом 5 лет назад. Вместе с развитием отрасли меняются требования к специалистам и подходы к обучению. Значит, для анализа и выбора специальности необходимо найти только только свежую информацию.

Я отобрал интервью с HR специалистами, датированные 2018-2019 годами. Специалисты ![утверждают](https://habr.com/ru/company/netologyru/blog/454320/), что спрос на аналитиков и дата сайентистов будет ![расти](https://vc.ru/hr/91338-data-science-karernyy-obzor-2019-goda).  
Копнем чуть глубже. Согласитесь, что и крупные компании, и начинающие стартапы работают с большими объемами данных. Во главе любого бизнеса стоит максимизация прибыли и снижение уровня издержек. Без глубокой аналитической работы и предиктивных моделей поведения, компания не сможет показывать требуемых финансовых результатов. 
С цифровизацие бизнеса спрос на оба направления, аналитика и сайентиста, будет расти. Думаю, к завершению учебы рабочих мест на стартовых позициях будет достаточно для относительно спокойного поиска работы. Осталось только выбрать между аналитиком и data scientist'oм.

<h2>Разговоры с коллегами-специалистами</h2>

Что сможет рассказать о работе лучше, чем описание вакансии? Вероятно, только специалист. В моем окружении не было коллег, связанных с DS, я отправился к аналитикам. После нескольких встреч с коллегами аналитического отдела, я сформировал субъективное ощущение некоторой однообразности и скуки на рабочем месте. Коллеги вечно изучали трафик, следили за метриками и тестировали гипотезы. Возможно, сотрудники рассказывали мне про специфику работы слишком устало и не проявляя должного отношения к профессии. Особого интереса будущая специальность аналитика во мне не разожгла.
